...
export function getWeatherDescription(code: number): {
  ...
  if (code === 0)
    return { type: 'sunny', icon: '☀️', label: '快晴', labelEn: 'Clear', droneFlightOk: true }
  if (code === 1)
    return { type: 'sunny', icon: '🌤️', label: '晴れ', labelEn: 'Mainly Clear', droneFlightOk: true }
  if (code === 2)
    return {
      type: 'partly_cloudy',
      icon: '⛅',
  ...
  if (code === 3)
    return { type: 'cloudy', icon: '☁️', label: '曇り', labelEn: 'Overcast', droneFlightOk: true }
  if (code >= 45 && code <= 48)
    return { type: 'foggy', icon: '🌫️', label: '霧', labelEn: 'Fog', droneFlightOk: false }
  if (code >= 51 && code <= 55)
    return { type: 'rainy', icon: '🌦️', label: '霧雨', labelEn: 'Drizzle', droneFlightOk: false }
  if (code >= 56 && code <= 57)
    return {
      type: 'snowy',
      icon: '🌨️',
  ...
  if (code >= 61 && code <= 65)
    return { type: 'rainy', icon: '🌧️', label: '雨', labelEn: 'Rain', droneFlightOk: false }
  if (code >= 66 && code <= 67)
    return {
      type: 'snowy',
      icon: '🌨️',
  ...
  if (code >= 71 && code <= 75)
    return { type: 'snowy', icon: '❄️', label: '雪', labelEn: 'Snow', droneFlightOk: false }
  if (code === 77)
    return {
      type: 'snowy',
      icon: '🌨️',
  ...
  return { type: 'cloudy', icon: '🌡️', label: '不明', labelEn: 'Unknown', droneFlightOk: true }
}
...
export const JAPAN_PREFECTURES = [
  ...
  { id: 'iwate', name: '岩手県', capital: '盛岡', lat: 39.7, lng: 141.15, region: '東北' },
  { id: 'miyagi', name: '宮城県', capital: '仙台', lat: 38.27, lng: 140.87, region: '東北' },
  { id: 'akita', name: '秋田県', capital: '秋田', lat: 39.72, lng: 140.1, region: '東北' },
  ...
  // 中部
  { id: 'niigata', name: '新潟県', capital: '新潟', lat: 37.9, lng: 139.02, region: '中部' },
  { id: 'toyama', name: '富山県', capital: '富山', lat: 36.7, lng: 137.21, region: '中部' },
  ...
  { id: 'shiga', name: '滋賀県', capital: '大津', lat: 35.0, lng: 135.87, region: '近畿' },
  { id: 'kyoto', name: '京都府', capital: '京都', lat: 35.01, lng: 135.77, region: '近畿' },
  { id: 'osaka', name: '大阪府', capital: '大阪', lat: 34.69, lng: 135.5, region: '近畿' },
  ...
  // 中国
  { id: 'tottori', name: '鳥取県', capital: '鳥取', lat: 35.5, lng: 134.24, region: '中国' },
  ...
  { id: 'hiroshima', name: '広島県', capital: '広島', lat: 34.4, lng: 132.46, region: '中国' },
  ...
  // 九州
  { id: 'fukuoka', name: '福岡県', capital: '福岡', lat: 33.6, lng: 130.42, region: '九州' },
  { id: 'saga', name: '佐賀県', capital: '佐賀', lat: 33.25, lng: 130.3, region: '九州' },
  ...
  { id: 'kagoshima', name: '鹿児島県', capital: '鹿児島', lat: 31.6, lng: 130.56, region: '九州' },
  // 沖縄
