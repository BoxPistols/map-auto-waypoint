...
export const EMERGENCY_AIRSPACE = [
...
export const MANNED_AIRCRAFT_ZONES = [
  // 場外離着陸場（農業用等）
...
export const RADIO_INTERFERENCE_ZONES = [
  // 主要な通信施設周辺
...
export const getEmergencyAirspaceGeoJSON = () => {
  return {
    type: 'FeatureCollection',
...
export const getRemoteIdZonesGeoJSON = () => {
  return {
    type: 'FeatureCollection',
...
export const getMannedAircraftZonesGeoJSON = () => {
  return {
    type: 'FeatureCollection',
...
export const getRadioInterferenceZonesGeoJSON = () => {
  return {
    type: 'FeatureCollection',
...
export const getGeographicFeaturesSourceConfig = () => ({
  type: 'raster',
